                ...
                const AppSurface(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 4),
                      Text(
                        'Hire a staff member to grant clinic access.',
                      ),
                    ],
                  ),
                )
        ...
        content: Column(
          ...
          children: [
            ...
            const Text(
              ...
              'They will no longer be able to access the clinic app.',
            ),
          ],
        ),
        actions: [
    ...
    try {
      ...
      if (context.mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              'Unable to remove staff member: $error',
            ),
          ),
        );
      }
...
class _AddStaffPageState extends State<AddStaffPage> {
  ...
  Future<void> _save() async {
    ...
    if (_imageBytes == null) {
      _showMessage(
        'Select a profile picture before hiring staff.',
        error: true,
      );
      return;
    }
    ...
    try {
      ...
      // 2. Worker creates Firebase Auth account.
      // 3. Worker automatically generates Firebase UID.
      // 4. Worker saves staff/{uid} in Firestore.
      ...
      _showMessage(
        'Staff hired successfully. They can now log in.',
      );
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  'Firebase will automatically create the staff account and UID. The password is not stored in Firestore.',
                  style: TextStyle(
                    color: colors.onSurfaceVariant,
                  ),
                ),
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  label: Text(
                    _saving ? 'Hiring staff...' : 'Hire Staff',
                  ),
                ),
              ),
            ],
