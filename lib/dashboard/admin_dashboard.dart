...
class AdminDashboardPro extends StatelessWidget {
  ...
  const AdminDashboardPro({super.key, this.isDarkMode, this.onThemeToggle});
  ...
  Widget build(BuildContext context) {
    ...
    final backgroundColor =
        isDarkMode == true ? const Color(0xFF121212) : const Color(0xFFF4F6F8);
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          _dashboardCard(context, "Update Patient", Icons.edit, Colors.orange,
              () => _navigate(context, const UpdatePatientPage())),
          _dashboardCard(context, "Delete Patient", Icons.delete, Colors.red,
              () => _navigate(context, const DeletePatientPage())),
          _dashboardCard(context, "Search Patient", Icons.search, Colors.blue,
              () => _navigate(context, const SearchPatientPage())),
          _dashboardCard(
              context,
              "View All Patients",
              Icons.list,
